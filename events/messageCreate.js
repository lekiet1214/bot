...
module.exports = {
  ...
  async execute (message) {
    ...
    if (command === 'ping') {
      ...
      user.kick(reason).catch(error => message.channel.send(`Sorry ${message.author} I couldn't kick because of : ${error}`))
      ...
      user.ban(reason).catch(error => message.channel.send(`Sorry ${message.author} I couldn't ban because of : ${error}`))
      ...
      message.guild.unban(user).catch(error => message.channel.send(`Sorry ${message.author} I couldn't unban because of : ${error}`))
